...
namespace fsm
{
    ...
    void FSM::event_loop()
    {
        ...
        static event_manager::Event event = event_manager::g_event_manager.query_event();
        _dispatch(&event);
    }
